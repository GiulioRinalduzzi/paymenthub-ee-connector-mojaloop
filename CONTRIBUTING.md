...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-connector-mojaloop/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-connector-mojaloop) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-connector-mojaloop.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-connector-mojaloop.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-connector-mojaloop.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-connector-mojaloop.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mojaloop.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-mojaloop.git (push)
```
